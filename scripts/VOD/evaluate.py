...
class trackingEvaluation(object):
    ...
    def __init__(self, t_sha, gt_path="./scripts/KITTI", max_truncation = 0, min_height = 25, max_occlusion = 2, \
        ...
        self.n_sequences = len(clips_list)
        ...
        self.t_sha             = t_sha
        # self.t_path            = os.path.join('../../pointrcnn_vod/')
        # self.t_path            = os.path.join('../../pointrcnn_lidar_vod/')
        self.t_path            = os.path.join('../../pointrcnn_radar_vod/')
